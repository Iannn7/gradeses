    ...
    <div class="sidebar close">
        ...
        <ul class="nav-list">
            ...
            <li class="see">
                ...
                <ul class="sub-menu">
                    <li><a href="students.php" class="link-name">Student Records</a></li>
            ...
            <tbody>
                <?php 
                                    ...
                                    if(isset($_GET['search']))
                                    {
                                        ...
                                        $query = "SELECT * FROM student WHERE CONCAT(ID, GUARDIAN, GUARD_CONTACT, GUARD_ADDRESS) LIKE '%$filtervalues%' ";
