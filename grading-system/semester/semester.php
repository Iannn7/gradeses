...
<body>
    ...
    <div class="sidebar close">
        ...
        <ul class="nav-list">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li><a href="../subject/subjectsubject.php" class="link-name">Subject</a></li>
                    <li><a href="../subject/subjectsubject-list.php">List of Subjects</a></li>
                    <li><a href="../subject/subjectnew-record.php">Add New Subject</a></li>
                </ul>
            </li>
    ...
    <div class="home-section">
        <div class="home-content">
            ...
            <span class="text">List of Semester</span>
        </div>
      ...
      ?>
        ...
        <table class="content-table">
            <div class="add-new">
             <a href="add-sem.php" class="new">Add New</a>
            </div>
            <thead>
                <tr>
                    <th>Semester ID</th>
            ...
            <tbody>
              ...
              ?>
                ...
                <tr>
                    ...
                    <td>
                        <a href="semester.php?delete=<?= $row['ID']; ?>">Delete</a>
                        <a href="sem-update.php?update=<?= $row['ID']; ?>">Update</a>
                    </td>
