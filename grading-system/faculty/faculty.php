        ...
        <div class="home-content">
            ...
            <form action="#">
                <div class="form-input">
                    <input placeholder="Search Faculty Records" style="background-color: white;" type="text"
            ...
            <tbody>
                <?php 
                                    ...
                                    if(isset($_GET['search']))
                                    {
                                        ...
                                        $query = "SELECT * FROM faculty WHERE CONCAT(ID, FIRST_NAME, MIDDLE_NAME, LAST_NAME, BIRTH_DATE, GENDER, CONTACT_NUM, INSTITUTE, COURSE ) LIKE '%$filtervalues%' ";
