    ...
    <div class="sidebar close">
        ...
        <ul class="nav-list">
            ...
            <li class="see">
                ...
                <ul class="sub-menu">
                    <li><a href="institute.php" class="link-name">Institute</a></li>
                    <li><a href="institute-list.php">List of Institute</a></li>
                    <li><a href="new-record.php">Add New Record</a></li>
                </ul>
            </li>
        ...
        <div class="home-content">
            ...
            <form action="#">
                <div class="form-input">
                    <input placeholder="Search Institute" style="background-color: white;" type="text" name="search"
            ...
            <tbody>
                <?php 
                                    ...
                                    if(isset($_GET['search']))
                                    {
                                        ...
                                        $query = "SELECT * FROM institute WHERE CONCAT(ID, INSTIUTE_NAME ) LIKE '%$filtervalues%' ";
                ...
                <tr>
                    ...
                    <td><?= $row['ID']; ?></td>
                    <td><?= $row['INSTIUTE_NAME']; ?></td>\
                    <td>
                        <a href="institute.php?delete=<?= $row['ID']; ?>">Delete</a>
