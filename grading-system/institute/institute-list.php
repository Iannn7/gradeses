...
<body>
    ...
    <div class="sidebar close">
        ...
        <ul class="nav-list">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li><a href="faculty.php" class="link-name">Faculty Records</a></li>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li><a href="new-record.php">Add New Course</a></li>
                </ul>
            </li>
    ...
    <div class="home-section">
        <div class="home-content">
            ...
            <span class="text">List of Institute</span>
        </div>
      ...
      ?>
        ...
        <table class="content-table">
            ...
            <tbody>
                ...
                {
                    $UserID = $row['ID'];
                    $INSTIUTE_NAME = $row['INSTIUTE_NAME'];
              ?>

                <tr>
                    <td><?php echo $UserID ?></td>
                    <td><?php echo $INSTIUTE_NAME	 ?></td>
                    <td>
                        <a href="institute-list.php?delete=<?= $row['ID']; ?>">Delete</a>
