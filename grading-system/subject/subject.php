    ...
    <div class="sidebar close">
        ...
        <ul class="nav-list">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li><a href="../faculty/faculty.php" class="link-name">Faculty Record</a></li>
            ...
            <li class="see">
                ...
                <ul class="sub-menu">
                    ...
                    <li><a href="subject-list.php">List of Students</a></li>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li><a href="../institute/institute.php">Add New Record</a></li>
                </ul>
            </li>
        ...
        <div class="home-content">
            ...
            <form action="#">
                <div class="form-input">
                    <input placeholder="Search Subjects" style="background-color: white;" type="text" name="search"
            ...
            <tbody>
                <?php 
                                    ...
                                    if(isset($_GET['search']))
                                    {
                                        ...
                                        $query = "SELECT * FROM subjects WHERE CONCAT(ID, CODE, DESCRIPTION, UNIT, TYPE) LIKE '%$filtervalues%' ";
                ...
                <tr>
                    ...
                    <td><?= $row['TYPE']; ?></td>
                    <td>
                        <a href="subject.php?delete=<?= $row['ID']; ?>">Delete</a>
