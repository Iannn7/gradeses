        ...
        <ul class="nav-list">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li><a href="../subject/subject-list.php">List of Subject</a></li>
        ...
        <div class="home-content">
            ...
            <form action="#">
                <div class="form-input">
                    <input placeholder="Search Student Records" style="background-color: white;" type="text"
            ...
            <tbody>
                <?php 
                                    ...
                                    if(isset($_GET['search']))
                                    {
                                        ...
                                        $query = "SELECT * FROM student WHERE CONCAT(ID, FIRST_NAME, MIDDLE_NAME, LAST_NAME, BIRTH_DATE, GENDER, CONTACT_NUM, INSTITUTE, COURSE ) LIKE '%$filtervalues%' ";
